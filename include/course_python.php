...
if ($course_python == 0) {
  ...
  $sqll = " DELETE FROM token_course WHERE tcansee = '4' AND token= '{$_SESSION['token_python']}'";
  ...
  $sqll = "SELECT * FROM token_course WHERE tcansee = '4' AND token= '{$_SESSION['token_python']}'";
  ...
  if ($result->num_rows > 0) {
    ...
    $sqll = "UPDATE token_course SET tcansee = '4', token= '{$_SESSION['token_python']}'";
    ...
    $sqll = "INSERT INTO token_course (tcansee, token) VALUES ('4', '{$_SESSION['token_python']}')";
